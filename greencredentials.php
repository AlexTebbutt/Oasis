...
<title>Printers in Hammersmith & Fulham | Oasis Printing | Green Credentials</title>
</head>
<body>
	<div id="holder">
    <div id="greentop">
      ...
      <div class="clear"></div>
      <div id="greennavtitle"><h1 class="page-title">green credentials</h1></div>
    </div>
    <div id="gcmain">
      <p>95% of paper and card that we use is from sustainable forest and is chlorine free.</p>
      <p>Our print machine is waterless and chemical free.</p>
      <p>Our inks are made from vegetables.</p>
      <p>We use software which saves 30% ink coverage.</p>
      <p class="center">Our digital copier is made from recycled materials.</p>
      <p>Our products are delivered by ‘eco bikes and eco vans’.</p>
      <div id="fsclogo"><img src="images/fsc.jpg" alt="FSC logo"></div>
    </div>
  </div>
