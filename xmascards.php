...
<title>Printers in Hammersmith & Fulham | Oasis Printing |Christmas Cards</title>
</head>
<body>
	<div id="holder">
    ...
    <div id="main">
        <p class="xmascards"><a href="dyoxmascards.php">Christmas cards with your own design</a></p>
        <p class="xmascards"><a href="charityxmascards.php">Christmas cards charity collection&nbsp;<img src="images/CRUKLogo.jpg" alt="CRUKLogo" width="135" height="39" /></a></p>
    </div>
  </div>
<?php DispFooter(); ?>