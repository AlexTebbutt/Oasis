...
<title>Printers in Hammersmith & Fulham | Oasis Printing | How To Order</title>
</head>
<body>
	<div id="holder">
    <div id="bluetop">
      ...
      <div class="clear"></div>
      <div id="navtitle"><h1 class="page-title">how to order</h1></div>
    </div>
    <div id="htomain">
    	<h1 class="bold-massive">HOW TO ORDER</h1>
			<p>please email your artwork and tell us the quantity you require and the paper/card you require.</p>
			<p>please quote the web price and state the name of your company and contact details (your name/name of the company).</p>
			<p>we will contact you within the working day. if we have not then please call 020 7386 7755.</p>
			<p>when we contact you we will go through the details of your order and we will confirm a price. the cost of delivery will depend on weight, destination and speed of delivery required. we will be asking you for a credit/debit card payment for the total.</p>
			<h1 class="bold-massive">turnaround time</h1>
			<p>printing orders take approximately 4/5 working days plus delivery time from confirmation of order.</p>
			<p>copying and digital orders take 1/2 days plus delivery time from confirmation of order.</p>
			<p>digital proofs can be posted to you but this will slow down the process.</p>
    </div>
  </div>
